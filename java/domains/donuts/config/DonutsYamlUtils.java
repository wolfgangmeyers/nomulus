...
public final class DonutsYamlUtils {
  ...
  private static final String YAML_CONFIG_PROD =
      readResourceUtf8(DonutsRegistryConfig.class, "donuts-default-config.yaml");
  private static final String YAML_CONFIG_UNITTEST =
      readResourceUtf8(DonutsRegistryConfig.class, "donuts-unittest-config.yaml");
